...
const FRAMEFORAMTINFO videoFormatTable[] = {
	/* YUV 420 */
	{ MEDIASUBTYPE_I420, PIXEL_FORMAT_I420, 1 << 15, 8, 3, { 0, 1, 1, 0} },
	...
	/* YUV 4:2:2 */
	{ MEDIASUBTYPE_YUYV, PIXEL_FORMAT_YUYV, 1 << 13, 16, 1 }, /*422 16bits per pixel top-down image, YUYV packet */
	{ MEDIASUBTYPE_YVU9, PIXEL_FORMAT_YVU9, 1 << 13, 16, 1 },
	{ MEDIASUBTYPE_Y411, PIXEL_FORMAT_Y411, 1 << 13, 16, 1 },
	{ MEDIASUBTYPE_Y41P, PIXEL_FORMAT_Y41P, 1 << 13, 16, 1 },
	{ MEDIASUBTYPE_YUY2, PIXEL_FORMAT_YUY2, 1 << 13, 16, 1 },
	{ MEDIASUBTYPE_YVYU, PIXEL_FORMAT_YVYU, 1 << 13, 16, 1 },
	{ MEDIASUBTYPE_UYVY, PIXEL_FORMAT_UYVY, 1 << 13, 16, 1 },
...
HRESULT DShowVideoCapture::SampleCB(double SampleTime, IMediaSample *pSample)
{
	...
	//desc.planeStride = mWorkFrameInfo->planeStride;
